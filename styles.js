...
const STYLES = {
  ...
  'latepost-depth': {
    ...
    styles: {
      ...
      h3: 'font-size: 16px; font-weight: 600; color: #d32f2f !important; line-height: 1.45 !important; margin: 16px 0 10px; padding-left: 14px; border-left: 4px solid #d32f2f; position: relative;',
      ...
      p: 'font-size: 14px; margin: 8px 0 !important; line-height: 1.3 !important; color: #1a1a1a !important;',
      ...
      hr: 'margin: 10px auto; border: none; height: 2px; background: linear-gradient(to right, transparent, #d32f2f, transparent); max-width: 200px;',
  ...
  'wechat-anthropic': {
    name: 'Claude',
    styles: {
      container: 'max-width: 700px; margin: 0 auto; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", "Helvetica Neue", Arial, sans-serif; font-size: 17px; line-height: 1.75 !important; color: #2b2b2b !important; background-color: #faf9f700 !important; word-wrap: break-word; letter-spacing: -0.01em;',
      ...
      h2: 'font-size: 16px; font-weight: 600; color: #C15F3C !important; line-height: 1.25 !important; margin: 16px 0 16px; letter-spacing: -0.015em; background: linear-gradient(135deg, #C15F3C 0%, #9DC88D 100%); -webkit-background-clip: text; background-clip: text;',
      ...
      p: 'margin: 12px 0 !important; line-height: 1.3 !important; color: #2b2b2b !important; font-size: 14px; letter-spacing: -0.005em;',
      ...
      hr: 'margin: 16px auto; border: none; height: 2px; background: linear-gradient(to right, transparent, rgba(193, 95, 60, 0.3), rgba(157, 200, 141, 0.3), transparent); max-width: 200px;',
  ...
  'wechat-tech': {
    name: '技术风格',
    styles: {
      container: 'max-width: 740px; margin: 0 auto; padding: 10px 20px 20px 20px; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; font-size: 14px; line-height: 1.2 !important; color: #2c3e50 !important; background-color: #fff !important; word-wrap: break-word;',
      ...
      p: 'margin: 18px 0 !important; font-size: 14px !important; line-height: 1.2 !important; color: #3a3a3a !important;',
      ...
      li: 'margin: 10px 0; font-size: 14px !important; line-height: 1.2 !important; color: #3a3a3a !important;',
...
'wechat-medium': {
  ...
  'gaudi-organic': {
    name: '高迪·有机',
    styles: {
      container: 'max-width: 700px; margin: 0 auto; padding: 20px 24px 45px 24px; font-family: "Baskerville", "Georgia", serif; font-size: 14px; line-height: 1.2 !important; color: #3d2914 !important; background-color: #fff5e6 !important; word-wrap: break-word;',
      ...
      p: 'margin: 10px 0 !important; font-size: 14px !important; line-height: 1.2 !important; color: #3d2914 !important;',
      ...
      ol: 'margin: 20px 0; padding-left: 28px; list-style-type: decimal;',
      li: 'margin: 10px 0; font-size: 14px !important; line-height: 1.2 !important; color: #3d2914 !important; position: relative; background: linear-gradient(90deg, rgba(255, 193, 7, 0.1) 0%, transparent 30%); border-radius: 20px 40px 80px 20px / 80px 20px 40px 20px;',
